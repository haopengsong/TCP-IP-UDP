...
void tcpConn1(){
    ...
    for(int m=0;m<tweets.size();m++){
        ...
        cout << "Sending tweet information to the server: TweetB has sent "<< tosend.substr(1) << " to server \n";
    }

    
    printf("Upon sending all the tweets’ information to the server: Updating the server is done for TweetB  \n");
    printf("End of Phase 1: End of Phase 1 for TweetB \n");
...
void tcpConn2(){
    ...
    cout << "End of phase 2 End of phase 2 for TweetB" << endl;
}
